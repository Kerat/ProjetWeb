...
require_once "../model/modeleActivite.php";
...
?>
    <form method="post" name="1" style="background-color: #eee">
        ...
        <select name="id_cand" onchange="this.form.submit();">
...
if(!empty($_POST['id_cand'])&&($_POST['id_cand']>0)){ $id_cand=$_POST['id_cand']; $cand=new Candidat($_POST['id_cand'], $co, NULL);
    ...
    <div class="card-section" style="background-color:#eee;">
        <h3>Documents</h3>
    </div>
    <div class="card" style="background-color: #eee">
        ...
        <table>
            ...
            <tbody>
                    <?php Activite::afficheTableauActivite($id_cand, $co);?>
            </tbody>
        </table>
    </div>
